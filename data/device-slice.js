...
const updateDeviceInScene = (devData, scenes, sceneIndex, devIndex) => {
  if (devData) {
    ...
    //   if (devData.comFirstStartTimer) {
    //     scenes[sceneIndex].data[devIndex].comFirstStartTimer =
    //       devData.comFirstStartTimer;
    //   }
    //   if (devData.setTemperature) {
    //     scenes[sceneIndex].data[devIndex].setTemperature =
    //       devData.setTemperature;
    //   }
    //   if (devData.tempReturnDifference) {
    //     scenes[sceneIndex].data[devIndex].tempReturnDifference =
    //       devData.tempReturnDifference;
    //   }
    //   if (devData.delayRunTime) {
    //     scenes[sceneIndex].data[devIndex].delayRunTime = devData.delayRunTime;
    //   }
    //   if (devData.faultStartTime) {
    //     scenes[sceneIndex].data[devIndex].faultStartTime = devData.faultStartTime;
    //   }
    //   if (devData.faultStopTime) {
    //     scenes[sceneIndex].data[devIndex].faultStopTime = devData.faultStopTime;
    //   }
    //   if (devData.highTemperatureAlarm) {
    //     scenes[sceneIndex].data[devIndex].highTemperatureAlarm = devData.highTemperatureAlarm;
    //   }
    //   if (devData.lowTemperatureAlarm) {
    //     scenes[sceneIndex].data[devIndex].lowTemperatureAlarm = devData.lowTemperatureAlarm;
    //   }
    //   if (devData.alarmTempUpOffset) {
    //     scenes[sceneIndex].data[devIndex].alarmTempUpOffset =
    //       devData.alarmTempUpOffset;
    //   }
    //   if (devData.alarmTempDownOffset) {
    //     scenes[sceneIndex].data[devIndex].alarmTempDownOffset =
    //       devData.alarmTempDownOffset;
    //   }
    //   if (devData.alarmTempUpOffsetDelay) {
    //     scenes[sceneIndex].data[devIndex].alarmTempUpOffsetDelay = devData.alarmTempUpOffsetDelay;
    //   }
    //   if (devData.alarmTempDownOffsetDelay) {
    //     scenes[sceneIndex].data[devIndex].alarmTempDownOffsetDelay = devData.alarmTempDownOffsetDelay;
    //   }
    //   //
    // }
  }
