  ...
  */
  ...
  const handleRefrgPropertyReport = propData => {
    ...
    let newDevice = {
      ...
      onlineStatus: true,
      firmwareVersion: propData.Firmware_information,
      comFirstStartTimer: propData.Com_First_Start_Timer,
      setTemperature: propData.Set_temperature,
      tempReturnDifference: propData.Temp_return_difference,
      delayRunTime: propData.Delay_Run_Time,
      faultStartTime: propData.Fault_Start_Time,
      faultStopTime: propData.Fault_Stop_Time,
      highTemperatureAlarm: propData.High_Temperature_Alarm,
      lowTemperatureAlarm: propData.Low_Temperature_Alarm,
      alarmTempUpOffset: propData.Alarm_Temp_UpOffset,
      alarmTempDownOffset: propData.Alarm_Temp_DownOffset,
      alarmTempUpOffsetDelay: propData.Alarm_Temp_UpOffset_Delay,
      alarmTempDownOffsetDelay: propData.Alarm_Temp_DownOffset_Delay,
      frostingTemperature: propData.Frosting_temperature,
      stopDefrostingTemperature: propData.Stop_defrosting_temperature,
      maxDefrostingTimer: propData.Max_Defrosting_Timer,
      lowTempAccumulatedTime: propData.Low_Temp_Accumulated_Time,
      defrostingMode: propData.Defrosting_Mode,
      defrostingDisplayDelay: propData.Defrosting_Display_delay,
      defrostingCycle: propData.Defrosting_Cycle,
      drippingTime: propData.Dripping_Time,
      fanFirstStartTimer: propData.Fan_First_Start_Timer,
      fanOperatingMode: propData.Fan_Operating_Mode,
      highTempAlarmValue: propData.High_Temp_Alarm_Value,
      highTempProtectionValue: propData.High_Temp_Protection_Value,
      highTempReturnDifference: propData.High_Temp_Return_Difference,
    };
    dispatch(syncDevice(newDevice));
  };
